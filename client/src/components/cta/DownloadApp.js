...
import mockupImageSrc from "assets/img/app-mockup.png"
import { ReactComponent as SvgDecoratorBlob1 } from "assets/img/svg-decorator-blob-9.svg";
import { ContentWithPaddingXl, Container as ContainerBase } from "components/misc/Layouts";
import { SectionHeading, Subheading as SubheadingBase } from "components/misc/Headings.js";
import appleIconImageSrc from "assets/img/apple-icon.png";
import googlePlayIconImageSrc from "assets/img/google-play-icon.png"
...
export default ({
  ...
  text = "Developers all over the world are happily using HelaView.",
  link1Text = "App Store",
