...
import {ReactComponent as EmailNewsletterIconBase } from "../../assets/img/email-newsletter-icon.svg"
...
const Input = tw.input`w-full sm:w-auto block sm:inline-block px-6 py-4 rounded bg-gray-700 tracking-wider font-bold border border-gray-600 focus:border-gray-300 focus:outline-none sm:rounded-r-none hover:bg-gray-800 transition duration-300 text-gray-200`
const Button = tw(PrimaryButton)`w-full sm:w-auto mt-6 sm:mt-0 sm:rounded-l-none py-4 bg-primary-500 text-gray-100 hocus:bg-primary-700 hocus:text-gray-300 border border-primary-500 hocus:border-primary-700`
