...
import logoImageSrc from "assets/img/logo-light.svg";
import serverIllustrationImageSrc from "assets/img/server-illustration-2.svg";
...
export default ({
  ...
  const navLinks = [
    <NavLinks key={1}>
      ...
      <PrimaryLink href="/register">Signup</PrimaryLink>
    </NavLinks>
  ];
  return (
